# github.com/databricks/sdk-go/keyconfigurations
...
```bash
go get github.com/databricks/sdk-go/keyconfigurations@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/keyconfigurations/v1"

client, err := keyconfigurations.NewClient(ctx)
if err != nil {
	return err
}
```

...
func TestSequence_Match_OrderedSequence(t *testing.T) {
	seq := NewSequence(
		Fixture{Method: "POST", Path: "/api/create", Response: map[string]any{"id": 1}},
		Fixture{Method: "GET", Path: "/api/get", Response: map[string]any{"id": 1}},
...
func TestSequence_Match_ExpectedBody(t *testing.T) {
	seq := NewSequence(
		Fixture{
			Method:       "POST",
			Path:         "/api/create",
			ExpectedBody: map[string]any{"name": "test"},
			Response:     map[string]any{"id": 1},
		},
	)
...
func TestSequence_Match_ExpectedBodyMismatch(t *testing.T) {
	seq := NewSequence(
		Fixture{
			Method:       "POST",
			Path:         "/api/create",
			ExpectedBody: map[string]any{"name": "expected"},
		},
	)

	body, _ := json.Marshal(map[string]any{"name": "actual"})
...
func TestSequence_Reset(t *testing.T) {
	seq := NewSequence(
		Fixture{Method: "GET", Path: "/api/test", Response: map[string]any{"id": 1}},
	)

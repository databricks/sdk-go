# github.com/databricks/sdk-go/aifunctions
...
```bash
go get github.com/databricks/sdk-go/aifunctions@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/aifunctions/v1"

client, err := aifunctions.NewClient(ctx)
if err != nil {
	return err
}
```

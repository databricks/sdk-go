# github.com/databricks/sdk-go/clusterlibraries
...
```bash
go get github.com/databricks/sdk-go/clusterlibraries@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/clusterlibraries/v2"

client, err := clusterlibraries.NewClient(ctx)
if err != nil {
	return err
}
```

# github.com/databricks/sdk-go/storageconfigurations
...
```bash
go get github.com/databricks/sdk-go/storageconfigurations@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/storageconfigurations/v1"

client, err := storageconfigurations.NewClient(ctx)
if err != nil {
	return err
}
```

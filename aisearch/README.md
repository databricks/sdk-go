# github.com/databricks/sdk-go/aisearch
...
```bash
go get github.com/databricks/sdk-go/aisearch@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/aisearch/v1"

client, err := aisearch.NewClient(ctx)
if err != nil {
	return err
}
```

...
| [clientinfo](https://pkg.go.dev/github.com/databricks/sdk-go/core/clientinfo) | Client metadata for User-Agent headers and shared detection of runtimes, CI/CD providers, coding agents, and agent meta-harnesses. |
...
| [types](https://pkg.go.dev/github.com/databricks/sdk-go/core/types) | Protocol Buffer-compatible duration and timestamp values with nanosecond precision. |

# github.com/databricks/sdk-go/modelregistry
...
```bash
go get github.com/databricks/sdk-go/modelregistry@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/modelregistry/v1"

client, err := modelregistry.NewClient(ctx)
if err != nil {
	return err
}
```

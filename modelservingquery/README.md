# github.com/databricks/sdk-go/modelservingquery
...
```bash
go get github.com/databricks/sdk-go/modelservingquery@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/modelservingquery/v1"

client, err := modelservingquery.NewClient(ctx)
if err != nil {
	return err
}
```

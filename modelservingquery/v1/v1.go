...
func (c *Client) Query(ctx context.Context, req *QueryEndpointInput, opts ...api.Option) (*QueryEndpointResponse, error) {
	...
	baseURL.Path = fmt.Sprintf("/api/serving-endpoints/%v/invocations", *req.Name)
	queryParams := url.Values{}
	baseURL.RawQuery = queryParams.Encode()

	resp := &QueryEndpointResponse{}

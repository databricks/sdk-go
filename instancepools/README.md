# github.com/databricks/sdk-go/instancepools
...
```bash
go get github.com/databricks/sdk-go/instancepools@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/instancepools/v2"

client, err := instancepools.NewClient(ctx)
if err != nil {
	return err
}
```

# github.com/databricks/sdk-go/features
...
```bash
go get github.com/databricks/sdk-go/features@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/features/v1"

client, err := features.NewClient(ctx)
if err != nil {
	return err
}
```

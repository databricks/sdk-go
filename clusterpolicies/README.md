# github.com/databricks/sdk-go/clusterpolicies
...
```bash
go get github.com/databricks/sdk-go/clusterpolicies@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/clusterpolicies/v2"

client, err := clusterpolicies.NewClient(ctx)
if err != nil {
	return err
}
```

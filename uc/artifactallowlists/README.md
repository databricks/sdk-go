# github.com/databricks/sdk-go/uc/artifactallowlists
...
```bash
go get github.com/databricks/sdk-go/uc/artifactallowlists@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/artifactallowlists/v1"

client, err := artifactallowlists.NewClient(ctx)
if err != nil {
	return err
}
```

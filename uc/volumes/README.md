# github.com/databricks/sdk-go/uc/volumes
...
```bash
go get github.com/databricks/sdk-go/uc/volumes@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/volumes/v1"

client, err := volumes.NewClient(ctx)
if err != nil {
	return err
}
```

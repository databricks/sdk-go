# github.com/databricks/sdk-go/uc/systemschemas
...
```bash
go get github.com/databricks/sdk-go/uc/systemschemas@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/systemschemas/v1"

client, err := systemschemas.NewClient(ctx)
if err != nil {
	return err
}
```

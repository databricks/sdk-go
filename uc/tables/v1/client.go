...
func (c *internalClient) CreateTable(ctx context.Context, req *CreateTableRequest, opts ...call.Option) (*TableInfo, error) {
	body, err := json.Marshal(createTableRequestToWire(req))
	if err != nil {
		return nil, err
	}
	...
	call := func(ctx context.Context) error {
		...
		resp = tableInfoFromWire(&wireResp)
		return nil
	}
...
func (c *internalClient) CreateTableConstraint(ctx context.Context, req *CreateTableConstraintRequest, opts ...call.Option) (*TableConstraint, error) {
	body, err := json.Marshal(createTableConstraintRequestToWire(req))
	if err != nil {
		return nil, err
	}
	...
	call := func(ctx context.Context) error {
		...
		resp = tableConstraintFromWire(&wireResp)
		return nil
	}
...
func (c *internalClient) DeleteTableConstraint(ctx context.Context, req *DeleteTableConstraintRequest, opts ...call.Option) (*DeleteTableConstraintResponse, error) {
	...
	baseURL.Path, baseURL.RawPath = pb.build()
	queryParams := url.Values{}
	if err := addQueryValue(queryParams, "constraint_name", req.ConstraintName); err != nil {
		return nil, err
	}
...
func (c *internalClient) GetTable(ctx context.Context, req *GetTableRequest, opts ...call.Option) (*TableInfo, error) {
	...
	baseURL.Path, baseURL.RawPath = pb.build()
	queryParams := url.Values{}
	if err := addQueryValue(queryParams, "include_delta_metadata", req.IncludeDeltaMetadata); err != nil {
		return nil, err
	}
	if err := addQueryValue(queryParams, "include_browse", req.IncludeBrowse); err != nil {
		return nil, err
	}
	if err := addQueryValue(queryParams, "include_manifest_capabilities", req.IncludeManifestCapabilities); err != nil {
		return nil, err
	}
	baseURL.RawQuery = queryParams.Encode()
	urlStr := baseURL.String()
...
func (c *internalClient) ListTableSummaries(ctx context.Context, req *ListTableSummariesRequest, opts ...call.Option) (*ListTableSummariesResponse, error) {
	...
	if err := addQueryValue(queryParams, "schema_name_pattern", req.SchemaNamePattern); err != nil {
		return nil, err
	}
	if err := addQueryValue(queryParams, "table_name_pattern", req.TableNamePattern); err != nil {
		return nil, err
	}
	...
	call := func(ctx context.Context) error {
		...
		resp = listTableSummariesResponseFromWire(&wireResp)
		return nil
	}
...
func (c *internalClient) ListTables(ctx context.Context, req *ListTablesRequest, opts ...call.Option) (*ListTablesResponse, error) {
	...
	if err := addQueryValue(queryParams, "omit_columns", req.OmitColumns); err != nil {
		return nil, err
	}
	if err := addQueryValue(queryParams, "omit_properties", req.OmitProperties); err != nil {
		return nil, err
	}
	if err := addQueryValue(queryParams, "omit_username", req.OmitUsername); err != nil {
		return nil, err
	}
	if err := addQueryValue(queryParams, "include_browse", req.IncludeBrowse); err != nil {
		return nil, err
	...
	call := func(ctx context.Context) error {
		...
		resp = listTablesResponseFromWire(&wireResp)
		return nil
	}
...
func (c *internalClient) TableExists(ctx context.Context, req *TableExistsRequest, opts ...call.Option) (*TableExistsResponse, error) {
	...
	call := func(ctx context.Context) error {
		...
		resp = tableExistsResponseFromWire(&wireResp)
		return nil
	}
...
func (c *internalClient) UpdateTable(ctx context.Context, req *UpdateTableRequest, opts ...call.Option) (*UpdateTableResponse, error) {
	body, err := json.Marshal(updateTableRequestToWire(req))
	if err != nil {
		return nil, err
	}

# github.com/databricks/sdk-go/uc/tables
...
```bash
go get github.com/databricks/sdk-go/uc/tables@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/tables/v1"

client, err := tables.NewClient(ctx)
if err != nil {
	return err
}
```

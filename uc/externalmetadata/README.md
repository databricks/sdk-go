# github.com/databricks/sdk-go/uc/externalmetadata
...
```bash
go get github.com/databricks/sdk-go/uc/externalmetadata@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/externalmetadata/v1"

client, err := externalmetadata.NewClient(ctx)
if err != nil {
	return err
}
```

# github.com/databricks/sdk-go/uc/workspacebindings
...
```bash
go get github.com/databricks/sdk-go/uc/workspacebindings@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/workspacebindings/v1"

client, err := workspacebindings.NewClient(ctx)
if err != nil {
	return err
}
```

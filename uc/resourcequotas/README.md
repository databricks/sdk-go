# github.com/databricks/sdk-go/uc/resourcequotas
...
```bash
go get github.com/databricks/sdk-go/uc/resourcequotas@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/resourcequotas/v1"

client, err := resourcequotas.NewClient(ctx)
if err != nil {
	return err
}
```

# github.com/databricks/sdk-go/uc/registeredmodels
...
```bash
go get github.com/databricks/sdk-go/uc/registeredmodels@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/registeredmodels/v1"

client, err := registeredmodels.NewClient(ctx)
if err != nil {
	return err
}
```

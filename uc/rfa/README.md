# github.com/databricks/sdk-go/uc/rfa
...
```bash
go get github.com/databricks/sdk-go/uc/rfa@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/rfa/v1"

client, err := rfa.NewClient(ctx)
if err != nil {
	return err
}
```

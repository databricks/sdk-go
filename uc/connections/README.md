# github.com/databricks/sdk-go/uc/connections
...
```bash
go get github.com/databricks/sdk-go/uc/connections@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/connections/v1"

client, err := connections.NewClient(ctx)
if err != nil {
	return err
}
```

# github.com/databricks/sdk-go/uc/metastores
...
```bash
go get github.com/databricks/sdk-go/uc/metastores@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/metastores/v1"

client, err := metastores.NewClient(ctx)
if err != nil {
	return err
}
```

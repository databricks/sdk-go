# github.com/databricks/sdk-go/uc/externallocations
...
```bash
go get github.com/databricks/sdk-go/uc/externallocations@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/uc/externallocations/v1"

client, err := externallocations.NewClient(ctx)
if err != nil {
	return err
}
```

# github.com/databricks/sdk-go/knowledgeassistants
...
```bash
go get github.com/databricks/sdk-go/knowledgeassistants@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/knowledgeassistants/v1"

client, err := knowledgeassistants.NewClient(ctx)
if err != nil {
	return err
}
```

# github.com/databricks/sdk-go/aigateway
...
```bash
go get github.com/databricks/sdk-go/aigateway@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/aigateway/v1"

client, err := aigateway.NewClient(ctx)
if err != nil {
	return err
}
```

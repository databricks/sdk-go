# github.com/databricks/sdk-go/globalinitscripts
...
```bash
go get github.com/databricks/sdk-go/globalinitscripts@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/globalinitscripts/v2"

client, err := globalinitscripts.NewClient(ctx)
if err != nil {
	return err
}
```

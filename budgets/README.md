# github.com/databricks/sdk-go/budgets
...
```bash
go get github.com/databricks/sdk-go/budgets@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/budgets/v1"

client, err := budgets.NewClient(ctx)
if err != nil {
	return err
}
```

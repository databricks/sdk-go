# github.com/databricks/sdk-go/instanceprofiles
...
```bash
go get github.com/databricks/sdk-go/instanceprofiles@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/instanceprofiles/v2"

client, err := instanceprofiles.NewClient(ctx)
if err != nil {
	return err
}
```

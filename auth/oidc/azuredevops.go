...
// NewAzureDevOpsIDTokenProvider returns a new IDTokenProvider that retrieves an
...
func NewAzureDevOpsIDTokenProvider(client *httpclient.ApiClient) (IDTokenProvider, error) {
	ts := &azureDevOpsIDTokenProvider{Client: client}
...
// azureDevOpsIDTokenProvider retrieves JWT Tokens from Azure DevOps Pipelines.
type azureDevOpsIDTokenProvider struct {
...
func (a *azureDevOpsIDTokenProvider) IDToken(ctx context.Context, audience string) (*IDToken, error) {

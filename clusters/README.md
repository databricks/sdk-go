# github.com/databricks/sdk-go/clusters
...
```bash
go get github.com/databricks/sdk-go/clusters@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/clusters/v2"

client, err := clusters.NewClient(ctx)
if err != nil {
	return err
}
```

# github.com/databricks/sdk-go/experiments
...
```bash
go get github.com/databricks/sdk-go/experiments@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/experiments/v1"

client, err := experiments.NewClient(ctx)
if err != nil {
	return err
}
```

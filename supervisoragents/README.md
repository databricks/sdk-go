# github.com/databricks/sdk-go/supervisoragents
...
```bash
go get github.com/databricks/sdk-go/supervisoragents@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/supervisoragents/v1"

client, err := supervisoragents.NewClient(ctx)
if err != nil {
	return err
}
```

# github.com/databricks/sdk-go/featurestore
...
```bash
go get github.com/databricks/sdk-go/featurestore@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/featurestore/v1"

client, err := featurestore.NewClient(ctx)
if err != nil {
	return err
}
```

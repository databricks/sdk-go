...
func (c *internalClient) ListQueries(ctx context.Context, req *ListQueriesRequest, opts ...call.Option) (*ListQueriesResponse, error) {
	...
	if err := addQueryValue(queryParams, "filter_by", queryFilterToWire(req.FilterBy)); err != nil {
		return nil, err
	}
	...
	if err := addQueryValue(queryParams, "include_metrics", req.IncludeMetrics); err != nil {
		return nil, err
	}

# github.com/databricks/sdk-go/pipelines
...
```bash
go get github.com/databricks/sdk-go/pipelines@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/pipelines/v2"

client, err := pipelines.NewClient(ctx)
if err != nil {
	return err
}
```

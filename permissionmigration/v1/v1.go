...
// Migrate Permissions.
func (c *Client) MigratePermissions(ctx context.Context, req *MigratePermissionsRequest, opts ...api.Option) (*MigratePermissionsResponse, error) {
	...
	baseURL.Path = "/api/2.0/permissionmigration"
	queryParams := url.Values{}
	baseURL.RawQuery = queryParams.Encode()

	resp := &MigratePermissionsResponse{}

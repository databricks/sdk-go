# github.com/databricks/sdk-go/genie
...
```bash
go get github.com/databricks/sdk-go/genie@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/genie/v1"

client, err := genie.NewClient(ctx)
if err != nil {
	return err
}
```

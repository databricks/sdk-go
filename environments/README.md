# github.com/databricks/sdk-go/environments
...
```bash
go get github.com/databricks/sdk-go/environments@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/environments/v1"

client, err := environments.NewClient(ctx)
if err != nil {
	return err
}
```

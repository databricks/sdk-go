...
func (c *internalClient) CreateBudgetPolicy(ctx context.Context, req *CreateBudgetPolicyRequest, opts ...call.Option) (*BudgetPolicy, error) {
	body, err := json.Marshal(createBudgetPolicyRequestToWire(req))
	if err != nil {
		return nil, err
	}
	...
	call := func(ctx context.Context) error {
		...
		resp = budgetPolicyFromWire(&wireResp)
		return nil
	}
...
func (c *internalClient) ListBudgetPolicies(ctx context.Context, req *ListBudgetPoliciesRequest, opts ...call.Option) (*ListBudgetPoliciesResponse, error) {
	...
	if err := addQueryValue(queryParams, "filter_by", filterToWire(req.FilterBy)); err != nil {
		return nil, err
	}
	if err := addQueryValue(queryParams, "sort_spec", sortSpecToWire(req.SortSpec)); err != nil {
		return nil, err
	}
	baseURL.RawQuery = queryParams.Encode()
	urlStr := baseURL.String()
	...
	call := func(ctx context.Context) error {
		...
		resp = listBudgetPoliciesResponseFromWire(&wireResp)
		return nil
	}
...
func (c *internalClient) UpdateBudgetPolicy(ctx context.Context, req *UpdateBudgetPolicyRequest, opts ...call.Option) (*BudgetPolicy, error) {
	body, err := json.Marshal(budgetPolicyToWire(req.Policy))
	if err != nil {
		return nil, err
	}
	...
	baseURL.Path, baseURL.RawPath = pb.build()
	queryParams := url.Values{}
	if err := addQueryValue(queryParams, "limit_config", limitConfigToWire(req.LimitConfig)); err != nil {
		return nil, err
	}
	baseURL.RawQuery = queryParams.Encode()
	urlStr := baseURL.String()

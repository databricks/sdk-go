# github.com/databricks/sdk-go/sharing
...
```bash
go get github.com/databricks/sdk-go/sharing@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/sharing/v1"

client, err := sharing.NewClient(ctx)
if err != nil {
	return err
}
```

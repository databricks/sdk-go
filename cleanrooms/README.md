# github.com/databricks/sdk-go/cleanrooms
...
```bash
go get github.com/databricks/sdk-go/cleanrooms@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/cleanrooms/v1"

client, err := cleanrooms.NewClient(ctx)
if err != nil {
	return err
}
```

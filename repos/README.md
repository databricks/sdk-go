# github.com/databricks/sdk-go/repos
...
```bash
go get github.com/databricks/sdk-go/repos@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/repos/v1"

client, err := repos.NewClient(ctx)
if err != nil {
	return err
}
```

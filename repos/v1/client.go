...
func (c *internalClient) CreateRepo(ctx context.Context, req *CreateRepoRequest, opts ...call.Option) (*CreateRepoResponse, error) {
	...
	call := func(ctx context.Context) error {
		...
		resp, err = createRepoResponseFromWire(&wireResp)
		if err != nil {
			return err
		}
		return nil
...
func (c *internalClient) GetRepo(ctx context.Context, req *GetRepoRequest, opts ...call.Option) (*GetRepoResponse, error) {
	...
	call := func(ctx context.Context) error {
		...
		resp, err = getRepoResponseFromWire(&wireResp)
		if err != nil {
			return err
		}
		return nil
...
func (c *internalClient) ListRepos(ctx context.Context, req *ListReposRequest, opts ...call.Option) (*ListReposResponse, error) {
	...
	baseURL.Path = "/api/2.0/repos"
	queryParams := url.Values{}
	if err := addQueryValue(queryParams, "path_prefix", wireReq.PathPrefix); err != nil {
		return nil, err
	}
	if err := addQueryValue(queryParams, "next_page_token", wireReq.NextPageToken); err != nil {
		return nil, err
	}
	baseURL.RawQuery = queryParams.Encode()
	urlStr := baseURL.String()
	...
	call := func(ctx context.Context) error {
		...
		resp, err = listReposResponseFromWire(&wireResp)
		if err != nil {
			return err
		}
		return nil

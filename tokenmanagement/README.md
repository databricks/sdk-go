# github.com/databricks/sdk-go/tokenmanagement
...
```bash
go get github.com/databricks/sdk-go/tokenmanagement@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/tokenmanagement/v1"

client, err := tokenmanagement.NewClient(ctx)
if err != nil {
	return err
}
```

...
// type.
func (c *Client) CreateBillingUsageDashboard(ctx context.Context, req *CreateBillingUsageDashboard, opts ...api.Option) (*CreateBillingUsageDashboard_Response, error) {
	...
	baseURL.Path = "/api/2.0/accounts/{account_id}/dashboard"
	queryParams := url.Values{}
	baseURL.RawQuery = queryParams.Encode()

	resp := &CreateBillingUsageDashboard_Response{}
...
// type.
func (c *Client) GetBillingUsageDashboard(ctx context.Context, req *GetBillingUsageDashboard, opts ...api.Option) (*GetBillingUsageDashboard_Response, error) {
	...
	if req.WorkspaceId != nil {
		queryParams.Add("workspace_id", fmt.Sprintf("%v", *req.WorkspaceId))
	}
	if req.DashboardType != nil {
		queryParams.Add("dashboard_type", fmt.Sprintf("%v", *req.DashboardType))
	}
	baseURL.RawQuery = queryParams.Encode()

	resp := &GetBillingUsageDashboard_Response{}

...
// Creates an alert.
func (c *Client) CreateAlert(ctx context.Context, req *CreateAlertRequest, opts ...api.Option) (*Alert, error) {
	...
	baseURL.Path = "/api/2.0/sql/alerts"
...
// Gets an alert.
func (c *Client) GetAlert(ctx context.Context, req *GetAlertRequest, opts ...api.Option) (*Alert, error) {
	...
	baseURL.Path = fmt.Sprintf("/api/2.0/sql/alerts/%v", *req.Id)
	queryParams := url.Values{}
	baseURL.RawQuery = queryParams.Encode()
...
func (c *Client) ListAlerts(ctx context.Context, req *ListAlertsRequest, opts ...api.Option) (*ListAlertsResponse, error) {
...
func (c *Client) ListAlertsIter(ctx context.Context, req *ListAlertsRequest, opts ...api.Option) iter.Seq2[*ListAlertsResponseAlert, error] {
...
func (c *Client) TrashAlert(ctx context.Context, req *TrashAlertRequest, opts ...api.Option) (*Empty, error) {
...
// Updates an alert.
func (c *Client) UpdateAlert(ctx context.Context, req *UpdateAlertRequest, opts ...api.Option) (*Alert, error) {
	body, err := json.Marshal(req)
	if err != nil {
		return nil, err
	}

...
type AlertStatementParameter struct {
	...
	Name *string
	// The bound value for the parameter, given as a string. If omitted, the value
	// is interpreted as NULL.
	Value *string
	// The SQL data type of the parameter, e.g. STRING, INT, or DATE. Defaults to
	// STRING. This is a string rather than an enum because scalar subtypes such as
	// DECIMAL(10, 4) cannot be enumerated. Complex types such as ARRAY, MAP, and

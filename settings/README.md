# github.com/databricks/sdk-go/settings
...
```bash
go get github.com/databricks/sdk-go/settings@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/settings/v2"

client, err := settings.NewClient(ctx)
if err != nil {
	return err
}
```

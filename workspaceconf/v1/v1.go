...
func (c *Client) GetWorkspaceConf(ctx context.Context, req *GetWorkspaceConfRequest, opts ...api.Option) (*WorkspaceConf, error) {
	...
	baseURL.Path = "/api/2.0/workspace-conf"
	queryParams := url.Values{}
	if req.Keys != nil {
		queryParams.Add("keys", fmt.Sprintf("%v", *req.Keys))
	}
...
// disabling it.
func (c *Client) UpdateWorkspaceConf(ctx context.Context, req *WorkspaceConf, opts ...api.Option) error {

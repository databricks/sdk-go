# github.com/databricks/sdk-go/tokens
...
```bash
go get github.com/databricks/sdk-go/tokens@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/tokens/v1"

client, err := tokens.NewClient(ctx)
if err != nil {
	return err
}
```

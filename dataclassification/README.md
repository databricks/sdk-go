# github.com/databricks/sdk-go/dataclassification
...
```bash
go get github.com/databricks/sdk-go/dataclassification@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/dataclassification/v1"

client, err := dataclassification.NewClient(ctx)
if err != nil {
	return err
}
```

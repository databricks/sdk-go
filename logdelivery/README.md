# github.com/databricks/sdk-go/logdelivery
...
```bash
go get github.com/databricks/sdk-go/logdelivery@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/logdelivery/v1"

client, err := logdelivery.NewClient(ctx)
if err != nil {
	return err
}
```

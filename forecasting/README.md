# github.com/databricks/sdk-go/forecasting
...
```bash
go get github.com/databricks/sdk-go/forecasting@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/forecasting/v1"

client, err := forecasting.NewClient(ctx)
if err != nil {
	return err
}
```

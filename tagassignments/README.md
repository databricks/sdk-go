# github.com/databricks/sdk-go/tagassignments
...
```bash
go get github.com/databricks/sdk-go/tagassignments@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/tagassignments/v1"

client, err := tagassignments.NewClient(ctx)
if err != nil {
	return err
}
```

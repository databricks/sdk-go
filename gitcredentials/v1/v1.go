...
func (c *Client) CreateCredentials(ctx context.Context, req *CreateCredentials, opts ...api.Option) (*CreateCredentials_Response, error) {
	...
	resp := &CreateCredentials_Response{}
...
func (c *Client) DeleteCredentials(ctx context.Context, req *DeleteCredentials, opts ...api.Option) (*DeleteCredentials_Response, error) {
	...
	baseURL.Path = fmt.Sprintf("/api/2.0/git-credentials/%v", *req.Id)
	queryParams := url.Values{}
	if req.PrincipalId != nil {
		queryParams.Add("principal_id", fmt.Sprintf("%v", *req.PrincipalId))
	}
	baseURL.RawQuery = queryParams.Encode()

	resp := &DeleteCredentials_Response{}
...
func (c *Client) GetCredentials(ctx context.Context, req *GetCredentials, opts ...api.Option) (*GetCredentials_Response, error) {
...
func (c *Client) UpdateCredentials(ctx context.Context, req *UpdateCredentials, opts ...api.Option) (*UpdateCredentials_Response, error) {
	body, err := json.Marshal(req)
	if err != nil {
		return nil, err
	}
	...
	resp := &UpdateCredentials_Response{}

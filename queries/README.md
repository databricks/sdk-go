# github.com/databricks/sdk-go/queries
...
```bash
go get github.com/databricks/sdk-go/queries@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/queries/v1"

client, err := queries.NewClient(ctx)
if err != nil {
	return err
}
```

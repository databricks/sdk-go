# github.com/databricks/sdk-go/lakeview
...
```bash
go get github.com/databricks/sdk-go/lakeview@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/lakeview/v1"

client, err := lakeview.NewClient(ctx)
if err != nil {
	return err
}
```

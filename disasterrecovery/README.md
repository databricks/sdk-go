# github.com/databricks/sdk-go/disasterrecovery
...
```bash
go get github.com/databricks/sdk-go/disasterrecovery@latest
```

## Usage

```go
import "github.com/databricks/sdk-go/disasterrecovery/v1"

client, err := disasterrecovery.NewClient(ctx)
if err != nil {
	return err
}
```
